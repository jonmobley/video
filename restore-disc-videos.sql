-- Restore DISC Heroes videos that were removed during cleanup
-- Extracted from Git history commit 0967330d
-- Run this to add the videos back to your Supabase database

-- First, ensure the DISC categories exist
INSERT INTO categories (id, name, color, "order", page) VALUES
('disc-disc', 'DISC', '#007AFF', 0, 'disc'),
('disc-conflict', 'Conflict', '#FF3B30', 1, 'disc'),
('disc-adapted', 'Adapted', '#34C759', 2, 'disc')
